...
class EMsg(enum.IntEnum):
    ...
    BSSettleStart = 1404 # obsolete - renamed to BSSettleNOVA
    BSSettleNOVA = 1404
    ...
    BSCommitGCTxn = 1425
    BSQueryGCOrderStatus = 1426 # obsolete - renamed to BSQueryTransactionStatus
    BSQueryTransactionStatus = 1426
    BSQueryGCOrderStatusResponse = 1427 # obsolete - renamed to BSQueryTransactionStatusResponse
    ...
    BSPurchaseMicroTxn = 1437 # obsolete - renamed to BSPurchaseRunFraudChecks
    BSPurchaseRunFraudChecks = 1437
    BSPurchaseMicroTxnResponse = 1438 # obsolete - renamed to BSPurchaseRunFraudChecksResponse
    ...
    DPVacBanStats = 1606
    DPCoplayStats = 1607 # obsolete - renamed to DPBlockingStats
    ...
    CCSDeleteAllComments = 3161 # obsolete - renamed to CCSDeleteAllCommentsByAuthor
    CCSDeleteAllCommentsByAuthor = 3161
    CCSDeleteAllCommentsResponse = 3162 # obsolete - renamed to CCSDeleteAllCommentsByAuthorResponse
...
class EResult(enum.IntEnum):
    ...
    DiskFull = 54
    RemoteCallFailed = 55
    PasswordNotSet = 56 # renamed to PasswordUnset
    PasswordUnset = 56
    ...
    AccountLogonDeniedNoMailSent = 66 # renamed to AccountLogonDeniedNoMail
    ...
    AccountLocked = 73 # renamed to AccountLockedDown
    ...
    AccountLogonDeniedNeedTwoFactorCode = 85 # renamed to AccountLoginDeniedNeedTwoFactor
    AccountLoginDeniedNeedTwoFactor = 85
    ItemOrEntryHasBeenDeleted = 86 # renamed to ItemDeleted
    ItemDeleted = 86
    AccountLoginDeniedThrottle = 87
    TwoFactorCodeMismatch = 88
    TwoFactorActivationCodeMismatch = 89
    AccountAssociatedToMultiplePlayers = 90 # renamed to AccountAssociatedToMultiplePartners
    AccountAssociatedToMultiplePartners = 90
    NotModified = 91
    NoMobileDeviceAvailable = 92 # renamed to NoMobileDevice
    NoMobileDevice = 92
    TimeIsOutOfSync = 93 # renamed to TimeNotSynced
    TimeNotSynced = 93
    SMSCodeFailed = 94
    TooManyAccountsAccessThisResource = 95 # renamed to AccountLimitExceeded
